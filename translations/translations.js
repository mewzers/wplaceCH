...
const translations = {
  fr: {
    templateNotice: `Ce script permet d'afficher les templates : <a href="https://bluemarble.camilledaguin.fr/" target="_blank" rel="noopener noreferrer">bluemarble.camilledaguin.fr</a>.`,
  ...
  de: {
    templateNotice: `Dieses Skript zeigt die Vorlagen an: <a href="https://bluemarble.camilledaguin.fr/" target="_blank" rel="noopener noreferrer">bluemarble.camilledaguin.fr</a>.`,
  ...
  it: {
    templateNotice: `Questo script consente di visualizzare i template: <a href="https://bluemarble.camilledaguin.fr/" target="_blank" rel="noopener noreferrer">bluemarble.camilledaguin.fr</a>.`,
  ...
  en: {
    templateNotice: `This script allows displaying the templates: <a href="https://bluemarble.camilledaguin.fr/" target="_blank" rel="noopener noreferrer">bluemarble.camilledaguin.fr</a>.`,
...
document.getElementById("template-notice").innerHTML = messages.templateNotice;
